...
#trans_linear_labels::surface_features {
  ::major_road1_text[display_class=1][zoom>=11] {
    text-name:"[name]";
    text-face-name: @book-fonts;
    text-placement:line;
    text-halo-radius:2;
  ...
  ::major_road2[display_class=2][zoom>=12] {
    text-name:"[name]";
    text-face-name: @book-fonts;
    text-placement:line;
  ...
  ::major_road3[display_class=3][zoom>=12] {
    text-name:"[name]";
    text-face-name: @book-fonts;
    text-placement:line;
    text-halo-radius:2;
  ...
  ::major_road4[display_class=4][zoom>=14] {
    text-name:"[name]";
    text-face-name: @book-fonts;
    text-placement:line;
    text-halo-radius:2;
  ...
  ::minor_road[display_class=5][zoom>=14] {
    text-name:"[name]";
    text-face-name: @book-fonts;
    text-placement:line;
    text-halo-radius:2;
  ...
  ::service_road[display_class=6][zoom>=15] {
    text-name:"[name]";
    text-face-name: @book-fonts;
    text-placement:line;
    text-halo-radius:2;text-min-padding:20;text-min-distance:10;text-character-spacing:1;
  ...
  ::ferry[transportation = 'ferry'][zoom>=12] {
    text-name:"[name]";
  ...
  ::railroad[transportation = 'rail'][zoom>=16] {
    text-name:"[name]";
    text-face-name: @oblique-fonts;
    text-placement:line;
    text-halo-radius:2;
