#vector_point_labels2::point {
  ::airport[class=1070][zoom>=9] {
    ::icon {
      ...
      [display_class>=1] {
        [zoom>=11] {marker-file:url("markers/airfield.svg");}
      }
    }
    ::text[zoom>=10] {
      text-name:"''";
      ...
      text-wrap-width:50;
      [display_class=0] {
        [zoom>=10] {text-name:"[name]";text-transform:uppercase;}
      }
      [display_class>=1] {
  ...
  ::national_park[class=1061][zoom>=7] {
    ...
    [zoom>=16][display_class>=0][display_class<=4] {text-name:"[name]";text-size:16;}
    [zoom>=7][zoom<=9] {text-character-spacing:2}
    [zoom>=10] {text-character-spacing:3}
    text-fill:#006837;
...
*/
  ...
  ::water[class=1050],[class=1051],[class=1052],[class=1054] {
    ...
    [class=1051] {
      [zoom>=8][display_class=0] {text-name:"[name]"}
      [zoom>=9][display_class<=1] {text-name:"[name]"}
    }
    [class=1052] {
      [zoom>=9][display_class=0] {text-name:"[name]"}
      [zoom>=10][display_class<=1] {text-name:"[name]"}
    }
    [class=1054] {
      [display_class=5][zoom>=12] {text-name:"[name]"}
      [display_class>5][zoom>=16] {text-name:"[name]"}
    }
...
*/
  ...
  ::enclosed_traffic_area[class=1105][zoom>=14] {
